...
// Connect the first bot
	...
	SetGameModeText("Whatever U Want FR/DM");
	ShowNameTags(1);
	ShowPlayerMarkers(1);
	SetWorldTime(17);
	SetWeather(10);
...
//	    CMD:cmd(playerid,params2);
	    CMD:help(playerid,params2);
...
//			if(GetPlayerVirtualWorld(playerid) != 0)
			...
			{
			    case 0: CMD:drift(playerid,params2);
				case 1: CMD:airport(playerid,params2);//ls airport
		        case 2: CMD:boneyard(playerid,params2); //aa boneyard
		        case 3: CMD:chiliad(playerid,params2);
		        case 4: CMD:sf(playerid,params2); //sf airport
		        case 5: CMD:lv(playerid,params2); //lv airport
		        case 6: CMD:ls(playerid,params2); //ls downtown
		        case 7: CMD:sfd(playerid,params2); //sf downtown
		        case 8: CMD:lvstrip(playerid,params2); //lv downtown
		        case 9: CMD:desert(playerid,params2); //desert town
		        case 10: CMD:sex(playerid,params2); //sex shop
				case 11: CMD:random(playerid,params2); //random
				case 255: CMD:random(playerid,params2); //random
				default: CMD:airport(playerid,params2); //ls airport
			}
			return 1;
	    }
...
{
	SendDeathMessage(killerid,playerid,reason); //if they didnt suicide
	#if defined USE_XADMIN
	foreach(Player,i) if(Spec[i][SpectateID] == playerid  && Spec[i][Spectating]) { TogglePlayerSpectating(i,false); Spec[i][Spectating] = false, Spec[i][SpectateID] = INVALID_PLAYER_ID; }
	#endif
//	ResetPlayerWeapons(playerid);
...
//				SetPlayerArmour(playerid,100.0);
				if(gTeam[playerid] > 0 && gTeam[playerid] != 100)
				{
			   	...
			   	if(pstate[playerid] == PLAYER_STATE_DRIVER && badcar[playerid]) SetVehicleHealth(pvehicleid[playerid],9999);
			}
		    #if defined ANTI_CARJACK
...
//				    updatemag[pvehicleid[playerid]] = 0;
				}
				return 1;
			}
		}
...
//	 	if(!jump[playerid] || gTeam[playerid] || RaceParticipant[playerid]) return 1;
	...
	else if(newkeys & KEY_SUBMISSION)
	{
	    if(pvehicleid[playerid] != INVALID_VEHICLE_ID) //is player in car
	    {
			...
			switch(key2[playerid])
			{
				...
				case KEY2_FLIP: CMD:flip(playerid,params2);
				case KEY2_RAMP: CMD:putramp(playerid,params2);
				case KEY2_SKULLS: CMD:putskulls(playerid,params2);
				case KEY2_STOP: CMD:stop(playerid,params2);
			}
		}
	...
	else if(newkeys & KEY_YES)
	{
		...
		switch(keyy[playerid])
		{
			...
			case KEYY_MENU: CMD:menu(playerid,params2);
			case KEYY_DM: CMD:dm(playerid,params2);
			case KEYY_CAR: CMD:v(playerid,params2);
			case KEYY_GUN: CMD:gun(playerid,params2);
		}
		return 1;
	}
	else if(newkeys & KEY_NO)
	{
		...
		switch(keyn[playerid])
		{
			...
			case KEYN_STOP: CMD:stop(playerid,params2);
			case KEYN_RAMP: CMD:putramp(playerid,params2);
			case KEYN_MINE: CMD:putmine(playerid,params2);
			case KEYN_SKULLS: CMD:putskulls(playerid,params2);
			case KEYN_FLIP: CMD:flip(playerid,params2);
			case KEYN_EJECT: CMD:e(playerid,params2);
//			case KEYN_JIHAD: CMD:jihad(playerid,params2);
...
public OnPlayerEnterVehicle(playerid, vehicleid)
{
	foreach(Player,i)
	{
	    if(vehicleid == playercar[i] && i != playerid && reserve[i])
	    {
	        ...
	        return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} This vehicle is reserved by its creator. You may not enter the vehicle.");
	    }
	}
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    else if(dialogid == D_SOUNDS && response)
	{
	    ...
	    switch(listitem)
	    {
	        ...
	        case 20: sound = 7816;
	        case 21: sound = 7824;
	        case 22: CMD:s2(playerid,params2);
	    }
	    GetPlayerPos(playerid,playerx,playery,playerz);
	    foreach(Player,i)
	    {
...
// 9020,9402,9437,9613,9624,9639,10402,10408,10600,10607,10801,CMD:s
	else if(dialogid == D_SOUNDS2 && response)
	{
	    ...
	    switch(listitem)
	    {
	        ...
	        case 26: sound = 10607;
	        case 27: sound = 10801;
	        case 28: CMD:s(playerid,params2);
	    }
	    GetPlayerPos(playerid,playerx,playery,playerz);
	    foreach(Player,i)
	    {
	...
	{
	    if(response) CMD:cmd(playerid,params2);
		return 1;
	}
	else if(dialogid == D_HELP2)
	{
	    if(!response) CMD:menu(playerid,params2);
		return 1;
	}
	else if(dialogid == D_MENU && response)
	{
	    switch(listitem)
	    {
	        case 0: CMD:tele(playerid,params2);
	        case 1: CMD:dm(playerid,params2);
	        case 2: CMD:v(playerid,params2);
	        case 3: CMD:caroptions(playerid,params2);
	        case 4: CMD:radio(playerid,params2);
	        case 5: CMD:gun(playerid,params2);
	        case 6: CMD:spawn(playerid,params2);
	        case 7: CMD:key2(playerid,params2);
	        case 8: CMD:keyy(playerid,params2);
	        case 9: CMD:keyn(playerid,params2);
	        case 10: CMD:weather(playerid,params2);
	        case 11: CMD:pcolor(playerid,params2);
	        case 12: CMD:cmd(playerid,params2);
	        case 13: CMD:help(playerid,params2);
	        case 14: CMD:flymode(playerid,params2);
...
//"Repair Vehicle\nActivate SNOS\nActivate Bunny-Hop\nTune Car\nAdd Neon\nAdd Train Horn\nChange Wheels\nChange Car Color\nChange Paintjob\nAdd Gunship\nJunk The Car","Select","Close");
	{
	    switch(listitem)
	    {
	        case 0: CMD:fix(playerid,params2);
	        case 1: CMD:snos(playerid,params2);
	        case 2: CMD:jump(playerid,params2);
	        case 3: CMD:tune(playerid,params2);
	        case 4: CMD:neon(playerid,params2);
	        case 5: CMD:horn(playerid,params2);
	        case 6: CMD:wheels(playerid,params2);
	        case 7: CMD:color(playerid,params2);
	        case 8: CMD:paintj(playerid,params2);
	        case 9: CMD:gunship(playerid,params2);
	        case 10: CMD:junk(playerid,params2);
	    }
		return 1;
	}
...
//			SetVehicleVirtualWorld(veh,prevworld);
	...
	else if(dialogid == D_CAR && response)
	{
	    ...
	    {
	        #if defined SAMP03X
	        case 0: CMD:car(playerid,params2);
	        case 1: CMD:tuned(playerid,params2);
	        case 2: CMD:fastcars(playerid,params2);
	        case 3: CMD:vmusclelow(playerid,params2);
	        case 4: CMD:v2door(playerid,params2);
	        case 5: CMD:v4door(playerid,params2);
	        case 6: CMD:bikes(playerid,params2);
	        case 7: CMD:vcivil(playerid,params2);
	        case 8: CMD:vgovt(playerid,params2);
	        case 9: CMD:vhtruck(playerid,params2);
	        case 10: CMD:vltruck(playerid,params2);
	        case 11: CMD:vrccar(playerid,params2);
	        case 12: CMD:vrec(playerid,params2);
	        case 13: CMD:vsuv(playerid,params2);
	        case 14: CMD:vtrailer(playerid,params2);
	        case 15: CMD:plane(playerid,params2);
	        case 16: CMD:boat(playerid,params2);
	        case 17: CMD:dcar(playerid,params2);
			#else // if samp 03e
	        case 0: CMD:tuned(playerid,params2);
	        case 1: CMD:fastcars(playerid,params2);
	        case 2: CMD:vmusclelow(playerid,params2);
	        case 3: CMD:v2door(playerid,params2);
	        case 4: CMD:v4door(playerid,params2);
	        case 5: CMD:bikes(playerid,params2);
	        case 6: CMD:vcivil(playerid,params2);
	        case 7: CMD:vgovt(playerid,params2);
	        case 8: CMD:vhtruck(playerid,params2);
	        case 9: CMD:vltruck(playerid,params2);
	        case 10: CMD:vrccar(playerid,params2);
	        case 11: CMD:vrec(playerid,params2);
	        case 12: CMD:vsuv(playerid,params2);
	        case 13: CMD:vtrailer(playerid,params2);
	        case 14: CMD:plane(playerid,params2);
	        case 15: CMD:boat(playerid,params2);
	        case 16: CMD:dcar(playerid,params2);
			#endif //SAMP03X
	        default: return 1;
		}
		return 1;
	...
	else if(dialogid == D_TUNED && response)
	{
	    switch(listitem)
	    {
	        case 0: CMD:wrc(playerid,params2);
	        case 1:
			{
	...
	else if(dialogid == D_DM && response)
	{
	    switch(listitem)
	    {
	        case 0: return CMD:gang(playerid,params2);
...
//	        #define SPAO{%0,%1,%2,%3,%4,%5} SetPlayerAttachedObject(playerid, HELMET_SLOT, 18645, 2, (%0), (%1), (%2), (%3), (%4), (%5));
	...
	else if(dialogid == D_TELE && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:airports(playerid,params2);
			case 1:	CMD:stadiums(playerid,params2);
			case 2: CMD:interiors(playerid,params2);
			case 3: CMD:dm(playerid,params2);
			case 4: CMD:casino(playerid,params2);
			case 5: CMD:train(playerid,params2);
			case 6: CMD:cities(playerid,params2);
			case 7: CMD:chiliad(playerid,params2);
			case 8: CMD:cannon(playerid,params2);
			case 9: CMD:stuntcity(playerid,params2);
			case 10: CMD:drift(playerid,params2);
			case 11: CMD:skyway(playerid,params2);
			case 12: CMD:derby(playerid,params2);
			case 13: CMD:ramp(playerid,params2);
			case 14: CMD:basejump(playerid,params2);
			case 15: CMD:dirtpit(playerid,params2);
			case 16: CMD:pyramid(playerid,params2);
			case 17: CMD:desert(playerid,params2);
			case 18: CMD:bikepark(playerid,params2);
			case 19: CMD:beach(playerid,params2);
			case 20: CMD:tuner(playerid,params2);
			case 21: CMD:underwater(playerid,params2);
			case 22: CMD:trucker(playerid,params2);
			case 23: CMD:center(playerid,params2);
			case 24: CMD:space(playerid,params2);
			case 25: CMD:halfpipe(playerid,params2);
			case 26: CMD:basketcar(playerid,params2);
			case 27: CMD:loopramp(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
	else if(dialogid == D_AIRPORTS && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:airport(playerid,params2);
			case 1:	CMD:sf(playerid,params2);
			case 2: CMD:lv(playerid,params2);
			case 3: CMD:boneyard(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
	...
	else if(dialogid == D_STADIUMS && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:dirtarena(playerid,params2);
			case 1:	CMD:8track(playerid,params2);
			case 2: CMD:kickstart(playerid,params2);
			case 3: CMD:bloodbowl(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
	...
	else if(dialogid == D_INTERIORS && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:sex(playerid,params2);
			case 1:	CMD:androm(playerid,params2);
			case 2: CMD:shamal(playerid,params2);
			case 3: CMD:otb(playerid,params2);
			case 4: CMD:rctrack(playerid,params2);
			case 5: CMD:ammu(playerid,params2);
			case 6: CMD:dirtarena(playerid,params2);
			case 7: CMD:8track(playerid,params2);
			case 8: CMD:lc(playerid,params2);
			case 9: CMD:fia(playerid,params2);
			case 10: CMD:atrium(playerid,params2);
			case 11: CMD:kickstart(playerid,params2);
			case 12: CMD:bloodbowl(playerid,params2);

			case 13: CMD:fiabag(playerid,params2);
			case 14: CMD:cracklab(playerid,params2);
			case 15: CMD:range(playerid,params2);
			case 16: CMD:donut(playerid,params2);
			case 17: CMD:jefferson(playerid,params2);
			case 18: CMD:jizzys(playerid,params2);
			case 19: CMD:pigpen(playerid,params2);
			case 20: CMD:pump(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
	...
	else if(dialogid == D_CITIES && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:ls(playerid,params2);
			case 1:	CMD:sfdt(playerid,params2);
			case 2: CMD:lvdt(playerid,params2);
			case 3: CMD:blueberry(playerid,params2);
			case 4: CMD:carson(playerid,params2);
			case 5: CMD:elquebrados(playerid,params2);
			case 6: CMD:angelpine(playerid,params2);
			case 7: CMD:palomino(playerid,params2);
			case 8: CMD:montgomery(playerid,params2);
			case 9: CMD:dilimore(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
	...
	else if(dialogid == D_CASINO && response)
	{
	    ...
	    switch(listitem)
	    {
			case 0: CMD:casino1(playerid,params2);// Caligulas
			case 1:	CMD:casino2(playerid,params2); // Four Dragons
			case 2: CMD:casino3(playerid,params2);
	        default: return 1;
		}
		return 1;
	}
...
CMD:c(const playerid, const params[])
{
	CMD:cmd(playerid,params);
	return 1;
}
CMD:command(const playerid, const params[])
{
	CMD:cmd(playerid,params);
	return 1;
}
CMD:commands(const playerid, const params[])
{
	CMD:cmd(playerid,params);
	return 1;
}
CMD:cmds(const playerid, const params[])
{
	CMD:cmd(playerid,params);
	return 1;
}
CMD:cmd(const playerid, const params[])
{
...
CMD:t(const playerid, const params[])
{
	CMD:tele(playerid,params);
	return 1;
}
CMD:teles(const playerid, const params[])
{
	CMD:tele(playerid,params);
	return 1;
}
CMD:radio(const playerid, const params[])
{
...
#if defined TOYS
CMD:toys(const playerid, const params[])
{
...
CMD:airports(const playerid, const params[])
{
...
CMD:menu(const playerid, const params[])
{
...
CMD:tut1(const playerid, const params[])
{
...
CMD:tut2(const playerid, const params[])
{
...
CMD:debug(const playerid, const params[])
{
...
CMD:s(const playerid, const params[])
{
// 4001,4803,4804,5000,5003,5406,5848,7001,7005,7008,7009,7007,7011,7023,7208,7400,7410,7601,7607,7810,7816,7824,CMD:s2
...
CMD:s2(const playerid, const params[])
{
// 7834,7837,7840,7841,7852,7851,7857,7887,7891,8010,8017,8411,8624,8622,8656,8738,8830,9020,9402,9437,9613,9624,9639,10402,10408,10600,10607,10801,CMD:s
	ShowPlayerDialog(playerid, D_SOUNDS2, DIALOG_STYLE_LIST, "Choose sound","Slap you silly\nRun like fuck\nWant to come too\nDon't leave me\nWe're screwed\nHave to piss\nIn my eye\nStop touching yourself\nHe started it\nFuck you x3\nDeath wish\nCome out\nIdiota\nAint listening\nCrazy Bitch\nGoodbye\nStop shooting\nFucking sloth\nFuck off\nI'm gonna die\nGames up\nDon't even think\nYou pushing me\nAll aboard\nHold up\nHelp!\nCall 911\nBeat it\nMore Sounds","Select","Close");
	return 1;
	#pragma unused params
}
CMD:quiet(const playerid, const params[])
{
    PlayerPlaySound(playerid, 1188,0.0,0.0,0.0); // id 1188 stops ALL music
	if(!quiet[playerid])
	{
...
CMD:hideui(const playerid, const params[])
{
...
CMD:afk(const playerid, const params[])
{
	...
	{
		if(gTeam[playerid]) CMD:leave(playerid,params2);
...
CMD:drunk(const playerid, const params[])
{
...
CMD:space(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	else
	{
...
CMD:piss(const playerid, const params[])
{
...
CMD:jump(const playerid, const params[])
{
...
CMD:god(const playerid, const params[]) {
...
CMD:skin(const playerid, const params[])
 {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:saveskin(const playerid, const params[])
 {
    if(Variables[playerid][LoggedIn])
    {
...
CMD:key2(const playerid, const params[])
 {
...
CMD:pcolor(const playerid, const params[])
 {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:setspawn(const playerid, const params[])
 {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:spawn(const playerid, const params[])
 {
	CMD:setspawn(playerid,params2);
	return 1;
	#pragma unused params
}

CMD:nos(const playerid, const params[])
{
	if(IsInModVehicle(playerid))
	{
	    AddNosToVehicle(playerid,pvehicleid[playerid]);
...
CMD:neon(const playerid, const params[])
{
	#if defined NEON
	if(IsInModVehicle(playerid))
	{
...
CMD:horn(const playerid, const params[])
{
	if(horn[playerid])
	{
	    horn[playerid] = 0;
...
CMD:chicken(const playerid, const params[])
{
...
CMD:cow(const playerid, const params[])
{
...
CMD:putmine(const playerid, const params[])
{
...
CMD:putramp(const playerid, const params[])
{
	if(gTeam[playerid] > 0) return SendClientMessage(playerid, COLOR_ERROR, "{CC0000}[ERROR]:{C0C0C0} You're in a DM zone. Stop screwing with stunts and FIGHT!");
	if(HasPlayerObject(playerid)) return DestroyObjectEx(playerid);
...
CMD:putskulls(const playerid, const params[])
{
	if(gTeam[playerid] > 0) return SendClientMessage(playerid, COLOR_ERROR, "{CC0000}[ERROR]:{C0C0C0} You're in a DM zone. Stop screwing with stunts and FIGHT!");
...
CMD:fight(const playerid, const params[])
{
...
CMD:wheels(const playerid, const params[])
{
...
CMD:leave(const playerid, const params[])
{
	...
	GivePlayerWeapon(playerid,12,1);
	SetPlayerSkin(playerid,pskin[playerid]);
	CMD:airport(playerid,params2);
	return 1;
	#pragma unused params
}

CMD:flip(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	#pragma unused params
    if(pstate[playerid] == PLAYER_STATE_DRIVER)
	{ 
...
CMD:stop(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	#pragma unused params
    if(pstate[playerid] == PLAYER_STATE_DRIVER)
...
CMD:godcar(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	#pragma unused params
...
CMD:fix(const playerid, const params[])
{
	CMD:vr(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:vr(const playerid, const params[])
{
...
CMD:acar(const playerid, params[])
{
	if(!IsPlayerAdmin(playerid)) return 1;
	new Float:x, Float:y, Float:z, Float:a;
	new idx,acar;
...
CMD:rban(const playerid, params[])
{
...
CMD:vgovt(const playerid, params[])
{
...
CMD:vhtruck(const playerid, params[])
{
...
{
	CMD:pweather(playerid,params2);

	return 1;
	#pragma unused params
}
CMD:pweather(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:daynight(const playerid, const params[])
{
...
{
	CMD:ptime(playerid,params2);
	#pragma unused params
	return 1;
}
CMD:day(const playerid, const params[])
{
	SetPlayerTime(playerid,12,0);
	#pragma unused params
	return 1;
}
CMD:rain(const playerid, const params[])
{
	SetPlayerWeather(playerid,8);
	#pragma unused params
	return 1;
}
CMD:sun(const playerid, const params[])
{
	SetPlayerWeather(playerid,10);
	#pragma unused params
	return 1;
}
CMD:night(const playerid, const params[])
{
	SetPlayerTime(playerid,23,0);
	#pragma unused params
	return 1;
}
CMD:ptime(const playerid, const params[])
{
	ShowPlayerDialog(playerid, D_WEATHER, DIALOG_STYLE_LIST, "Choose Weather/Time","Sunny Day\nClear Night\nRainy Day\nRainy Night\nFoggy Day\nFoggy Night\nHOT Day\nSandstorm Day\nSandstorm Night\nPolluted Day\nPolluted Night","Select","Close");
	#pragma unused params
    return 1;
}
CMD:dcar(const playerid, const params[])
{
...
CMD:reserve(const playerid, const params[])
{
...
CMD:wrc(const playerid, const params[])
{
    if(gTeam[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:pc(const playerid, const params[]) {
	GivePlayerWeapon(playerid, 46, 1);
...
CMD:sdance(const playerid, params[]) {
...
CMD:hsmoke(const playerid, const params[]) {
	if(gTeam[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
	{
...
CMD:porn(const playerid, const params[]) {
	if(gTeam[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
	{
...
CMD:magic(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
    godmode[playerid] = 0;
	ShowGodTD(playerid);
...
CMD:jihad(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:findcar(const playerid, const params[])
{
	if(gTeam[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:getcar(const playerid, const params[])
{
...
CMD:color(const playerid, const params[])
{
...
CMD:colortest(const playerid, const params[])
{
...
CMD:paintjob(const playerid, const params[])
{
	if(pvehicleid[playerid] == INVALID_VEHICLE_ID || pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be in a vehicle to use this command");
...
CMD:plate(const playerid, const params[])
{
	if(pvehicleid[playerid] == INVALID_VEHICLE_ID || pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be in a vehicle to use this command");
...
CMD:paintj(const playerid, const params[])
{
	CMD:paintjob(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:rules(const playerid, const params[])
{
...
CMD:junk(const playerid, const params[])
{
...
CMD:savepos(const playerid, const params[])
{
	if(afk[playerid])
	{
		CMD:random(playerid,params2);
...
CMD:back(const playerid, const params[])
{
	if(afk[playerid])
	{
		CMD:random(playerid,params2);
...
CMD:dm(const playerid, const params[])
{
...
CMD:sp(const playerid, const params[])
{
	CMD:savepos(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:lp(const playerid, const params[])
{
	CMD:back(playerid,params2);
	return 1;
	#pragma unused params
}

CMD:basejump(const playerid, const params[])
{
    if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:casino(const playerid, const params[])
{
    if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
CMD:train(const playerid, const params[]) {
    if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(pstate[playerid] == PLAYER_STATE_DRIVER) RemovePlayerFromVehicle(playerid);
...
CMD:casino1(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:casino2(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:casino3(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:derby(const playerid, const params[])
{
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:cannon(const playerid, const params[]) {
	if(afk[playerid]) CMD:afk(playerid,params2);
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:ammu(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:center(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:random(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:jizzys(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:jefferson(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:range(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:cracklab(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:fiabag(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:donut(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:pigpen(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:sfdt(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:lvdt(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:carson(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:blueberry(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:elquebrados(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:angelpine(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:palomino(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:montgomery(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:dilimore(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:ls(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:sfa(const playerid, const params[])
{
	CMD:sf(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:sf(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:lva(const playerid, const params[])
{
	CMD:lv(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:lv(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:desert(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:sfd(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:lvstrip(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:skydive(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:chilliad(const playerid, const params[]) {
	CMD:chiliad(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:ch(const playerid, const params[]) {
	CMD:chiliad(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:lsa(const playerid, const params[])
{
	CMD:airport(playerid,params2);
	return 1;
	#pragma unused params
}
CMD:airport(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:tpallow(const playerid, const params[]) {
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:tpdeny(const playerid, const params[]) {
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	if(tpallow[playerid] == 0) // dont allow
	{
...
CMD:myworld(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:rallyup(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:trucker(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:boneyard(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:aa(const playerid, const params[]) {
	CMD:boneyard(playerid,params2);
	return 1;
	#pragma unused params
}

CMD:stuntcity(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:dirtpit(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	SetPlayerPosEx(playerid, 563.2621,914.0405,-42.9609);
	return 1;
	#pragma unused params
}
CMD:underwater(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
//	if(pvehicleid[playerid] == INVALID_VEHICLE_ID || pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientError(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be in a vehicle to use this command");
...
CMD:pyramid(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	SetPlayerPosEx(playerid, 2355.9192,1512.0405,42.8203);
	return 1;
	#pragma unused params
}
CMD:area69(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:silodm(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:basketcar(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	SetPlayerPosEx(playerid, 3168.371826, -2002.693847, 229.971847);
	return 1;
	#pragma unused params
}
CMD:loopramp(const playerid, const params[]) {
    if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:ramp(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	if (IsPlayerInAnyVehicle(playerid))
	{
		SetPlayerInterior(playerid,0);
...
CMD:halfpipe(const playerid, const params[]) {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	if (IsPlayerInAnyVehicle(playerid))
	{
		SetPlayerInterior(playerid,0);
...
CMD:skyway(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:roller(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:tuner(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
//   INTERIORS
//      -------------------------------
CMD:8track(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:dirtarena(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:kickstart(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:bloodbowl(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:lc(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:pump(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:fia(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:androm(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	else
...
CMD:shamal(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:otb(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:sex(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:atrium(const playerid, const params[])
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:insultshouse(const playerid, const params[])
{
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:prohouse(const playerid, const params[])
{
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientError(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
...
CMD:disableproperty(playerid,params[])
{
...
CMD:enableproperty(playerid,params[])
{
    if(!IsPlayerAdmin(playerid)) return 0;
    new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
CMD:locateproperty(playerid,params[])
{
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
	if(!strlen(tmp))
...
CMD:setpropertyearning(playerid,params[])
{
    if(!IsPlayerAdmin(playerid)) return 0;
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
CMD:getpropertyid(playerid,params[])
{
...
CMD:saveproperty(playerid,params[])
{
	if(!IsPlayerAdmin(playerid)) return 0;
...
#if defined RACES
CMD:racehelp(const playerid, const params[]) {
    #pragma unused params
    if(IsPlayerAdmin(playerid)) {
...
CMD:buildhelp(const playerid, const params[]) {
    #pragma unused params
...
CMD:buildrace(const playerid, const params[]) {
    #pragma unused params
...
CMD:cp(const playerid, const params[]) {
	#pragma unused params
...
CMD:scp(const playerid, const params[]) {
...
CMD:rcp(const playerid, const params[]) {
	#pragma unused params
	if(RaceBuilders[playerid] == 0)	{
		SendClientMessage(playerid, COLOR_RED, "You are not building a race!");
		return 1;
...
CMD:mcp(const playerid, const params[]) {
	if(RaceBuilders[playerid] == 0)	{
		SendClientMessage(playerid, COLOR_RED, "You are not building a race!");
		return 1;
	}
...
CMD:dcp(const playerid, const params[]) {
	#pragma unused params
	if(RaceBuilders[playerid] == 0)	{
		SendClientMessage(playerid, COLOR_RED, "You are not building a race!");
		return 1;
...
CMD:clearrace(const playerid, const params[]) {
	#pragma unused params
	if(RaceBuilders[playerid] != 0) clearrace(playerid);
	else SendClientMessage(playerid, COLOR_RED, "You are not building a race!");
	return 1;
}
CMD:editrace(const playerid, const params[]) {
	if(RaceBuilders[playerid] == 0) {
		SendClientMessage(playerid, COLOR_RED, "You are not building a race!");
		return 1;
	}
...
CMD:saverace(const playerid, const params[]) {
	if(RaceBuilders[playerid] != 0)	{
		new tmp[64], idx;
	    tmp = strtok(params, idx);
	    if(!tmp[0]) {
...
CMD:setlaps(const playerid, const params[]) {
	new tmp[128], idx;
    tmp = strtok(params, idx);
...
CMD:racemode(const playerid, const params[]) {
...
CMD:loadrace(const playerid, const params[]) {
...
CMD:startrace(const playerid, const params[]) {
	#pragma unused params
...
CMD:deleterace(const playerid, const params[]) {
...
CMD:join(const playerid, const params[]) {
...
CMD:leaverace(const playerid, const params[])
{
	LeaveRace(playerid);
    return 1;
    #pragma unused params
...
CMD:endrace(const playerid, const params[]) {
	if(IsPlayerAdmin(playerid)) {
	    if(RaceActive==0) {
...
CMD:racers(const playerid, const params[]) {
	foreach(Player,i) {
...
CMD:airrace(const playerid, const params[]) {
	#pragma unused params
	if(RaceBuilders[playerid] != 0)	{
...
CMD:cpsize(const playerid, const params[]) {
	new idx, tmp[64];
	tmp = strtok(params,idx);
...
CMD:prizemode(const playerid, const params[]) {
	if(!IsPlayerAdmin(playerid)) return 1;
	new idx, tmp;
...
CMD:setprize(const playerid, const params[]) {
	if(!IsPlayerAdmin(playerid)) return 1;
	new idx, tmp;
    tmp = strval(strtok(params, idx));
...
#if defined RACE_MENU
CMD:raceadmin(const playerid, const params[]) {
	#pragma unused params
	if(!IsPlayerAdmin(playerid)) return 1;
...
CMD:buildmenu(const playerid, const params[]) {
	#pragma unused params
	if(BuildAdmin == 1 && !IsPlayerAdmin(playerid)) return 1;
	if(RaceBuilders[playerid] == 0)	{
