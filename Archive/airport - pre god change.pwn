...
Move dodo to water
Add new interiors
Set up Wuzi's house for insultman911
install attachments, make them pro-only and change command to /toys

make /save save players POS in file
...
BETTER INDICATOR OF PEOPLE JOINING THEN BEING KICKED DUE TO PREEXISTING BAN
*/
...
new Float:gRandomStuntSpawn[5][4] = {
...
public OnGameModeInit()
{
	...
	AddProperty("Grove St House 1", 2469.64, -1648.20, 13.47, 26000, 8000, 525);
	AddProperty("Grove St House 2", 2489.25, -1646.48, 14.06, 30000, 8750, 600);
	AddProperty("Grove St House 3", 2498.56, -1644.10, 13.77, 19000, 4500, 400);
	AddProperty("Grove St House 4", 2522.61, -1658.78, 15.49, 20000, 5000, 400);
	AddProperty("Idlewood Apt 1",1974.6471,-1671.8373,18.5456,10000,2500,250); // idlewood-apt-1
	AddProperty("Idlewood Apt 2",1970.1598,-1671.4880,18.5456,10000,2500,250); // idlewood-apt-2
	AddProperty("Idlewood Apt 3",1969.9294,-1671.7964,15.9688,10000,2500,250); // idlewood-apt-3
	AddProperty("Idlewood Apt 4",1974.5104,-1671.8322,15.9688,10000,2500,250); // idlewood-apt-4
	AddProperty("Idlewood Apt 5",1972.1649,-1634.2264,18.5690,10000,2500,250); // idlewood-apt-5
	AddProperty("Idlewood Apt 6",1967.4825,-1634.1865,18.5690,10000,2500,250); // idlewood-apt-6
	AddProperty("Idlewood Apt 7",1967.6869,-1634.4686,15.9688,10000,2500,250); // idlewood-apt-7
	AddProperty("Idlewood Apt 8",1972.1337,-1634.5062,15.9688,10000,2500,250); // idlewood-apt-8
	AddProperty("Inglewood Bungalow 1",2017.2043,-1629.9382,13.5469,15000,4000,350); // idlewood-bungalow-1
	AddProperty("Inglewood Bungalow 2",2015.7544,-1641.5709,13.7824,15000,4000,350); // idlewood-bungalow-2
	AddProperty("Inglewood Bungalow 3",2013.1306,-1656.3727,13.8058,15000,4000,350); // idlewood-bungalow-3
	AddProperty("Inglewood Bungalow 4",2017.9633,-1703.4010,14.2344,15000,4000,350); // idlewood-bungalow-4
	AddProperty("Inglewood Bungalow 5",2015.5159,-1716.7458,13.5547,15000,4000,350); // idlewood-bungalow-5
	AddProperty("Inglewood Bungalow 6",2014.6533,-1732.6559,14.2344,15000,4000,350); // idlewood-bungalow-6
	AddProperty("Inglewood House 1",1981.1772,-1718.9705,17.0304,35000,10000,900); // idlewood-house-1
	AddProperty("Inglewood Duplex 1",1987.2510,-1605.9656,13.5285,25000,7000,600); // idlewood-duplex-1
	AddProperty("Inglewood Duplex 2",2002.8616,-1594.8431,13.5763,25000,7000,600); // idlewood-duplex-2
	AddProperty("Inglewood Duplex 3",2012.6807,-1595.4347,13.5791,25000,7000,600); // idlewood-duplex-3
	AddProperty("Inglewood Duplex 4",1972.9341,-1559.8777,13.6397,25000,7000,600); // idlewood-duplex-4
	AddProperty("Inglewood Duplex 5",1958.7467,-1560.2728,13.5944,25000,4000,600); // idlewood-duplex-5
	AddProperty("LS Bungalow",1894.3131,-2133.4731,15.4663,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1872.4357,-2133.0261,15.4820,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1851.6890,-2134.8403,15.3882,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1804.0496,-2124.5708,13.9424,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1802.0950,-2098.9412,14.0210,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1782.0819,-2126.2939,14.0679,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1781.4604,-2102.3503,14.0566,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1762.5770,-2101.9829,13.8570,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1761.1044,-2125.1858,14.0566,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1734.0037,-2098.1428,14.0366,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1734.6202,-2130.3591,14.0210,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1711.5599,-2101.2361,14.0210,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1715.2047,-2125.4524,14.0566,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1695.9221,-2125.3538,13.8101,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1686.8599,-2098.9675,13.8343,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1673.5161,-2122.3013,14.1460,10000,3000,300); // ls bungalow
	AddProperty("LS Bungalow",1667.6161,-2107.1072,14.0723,10000,3000,300); // ls bungalow
	AddProperty("verdant bluffs mansion 1",1123.3008,-2036.9685,69.8875,75000,20000,2000); // verdant-bluffs-mansion 1
	AddProperty("vinewood hills house-1",836.5254,-894.6529,68.7689,50000,15000,1100); // vinewood-hills-house-1
	AddProperty("vinewood hills house-2",828.0171,-858.1780,70.3308,50000,15000,1100); // vinewood-hills-house-2
	AddProperty("vinewood hills house-3",874.1689,-876.4576,77.7565,50000,15000,1100); // vinewood-hills-house-3
	AddProperty("vinewood hills house-4",859.8117,-847.6173,77.3750,50000,15000,1100);// vinewood-hills-house-4
	AddProperty("vinewood hills house-5",924.4163,-852.6858,93.4565,50000,15000,1100); // vinewood-hills-house-5
	AddProperty("vinewood hills house-6",937.1720,-847.9714,93.7155,50000,15000,1100); // vinewood-hills-house-6
	AddProperty("vinewood hills house-7",989.8436,-828.6307,95.4686,50000,15000,1100); // vinewood-hills-house-7
	AddProperty("sf duplex 1",-2641.7698,819.9052,49.9844,25000,4000,500); // sf duplex 1
	AddProperty("sf duplex 2",-2652.6890,820.3201,49.9844,25000,4000,500); // sf duplex 2
	AddProperty("sf duplex 3",-2666.9692,819.9836,49.9844,25000,4000,500); // sf duplex 3
	AddProperty("sf house 1",-2701.8833,820.5820,49.9844,35000,3000,800); // sf house 1
	AddProperty("sf duplex 4",-2709.8293,803.3262,49.9766,25000,4000,500); // sf duplex 4
	AddProperty("sf duplex 5",-2698.4343,803.7175,49.9703,25000,4000,500); // sf duplex 5
	AddProperty("sf duplex 6",-2687.8804,803.6013,49.9766,25000,4000,500); // sf duplex 6
	AddProperty("sf duplex 7",-2677.1179,803.4717,49.9766,25000,4000,500);// sf duplex 7
	AddProperty("sf duplex 8",-2670.6145,803.3565,49.9766,25000,4000,500); // sf duplex 8
	AddProperty("sf duplex 9",-2659.9614,803.0834,49.9766,25000,4000,500); // sf duplex 9
	AddProperty("sf duplex 10",-2645.6895,803.3356,49.9766,25000,4000,500); // sf duplex 10
	AddProperty("SF Duplex",-2094.3201,823.1947,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2112.4661,822.6729,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2112.6135,796.0907,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2094.2256,796.3285,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2066.9836,796.7134,65.1104,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2048.0833,796.3763,56.9519,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2030.0811,796.3939,49.5265,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2029.7424,820.3403,49.4043,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2048.1484,820.3095,56.9735,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2066.3809,820.3431,64.9855,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2112.6172,746.3486,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2094.5220,746.2431,69.5625,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2066.5828,745.4985,64.9719,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2048.2068,745.9830,57.0252,25000,4000,500); // sf duplex
	AddProperty("SF Duplex",-2029.5150,745.7653,49.3750,25000,4000,500); // sf duplex
	AddProperty("LV nice house+garage 1",1408.0502,1898.6573,11.4609,50000,15000,1100); // LV nice house 1
	AddProperty("LV house 1",1364.7120,1896.7605,11.4688,30000,5000,900); // LV house 1
	AddProperty("LV house 2",1364.0541,1931.5486,11.4683,30000,5000,900); // LV house 2
	AddProperty("LV house 3",1366.5883,1973.5337,11.4609,30000,5000,900); // LV house 3
	AddProperty("LV house 4",1364.4426,2003.7030,11.4609,30000,5000,900); // LV house 4
	AddProperty("LV house 5",1366.3221,2027.5739,11.4609,30000,5000,900);// LV house 5
	AddProperty("LV apt 1",1408.2209,2003.8444,10.8203,10000,2500,250); // LV apt 1
	AddProperty("LV apt 2",1408.1534,1996.5715,10.8203,10000,2500,250); // LV apt 2
	AddProperty("LV apt 3",1414.3234,2003.8066,10.8203,10000,2500,250); // LV apt 3
	AddProperty("LV apt 4",1414.5372,1996.3578,10.8203,10000,2500,250); // LV apt 4
	AddProperty("LV apt 5",1414.1842,2003.9055,14.7396,10000,2500,250); // LV apt 5
	AddProperty("LV apt 6",1414.4731,1996.3575,14.7396,10000,2500,250); // LV apt 6
	AddProperty("LV apt 7",1408.1813,2003.9099,14.7396,10000,2500,250); // LV apt 7
	AddProperty("LV apt 8",1408.3417,1996.3566,14.7396,10000,2500,250); // LV apt 8
#endif
...
// Connect the first bot
	...
	SetGameModeText("Stunt Race Freeroam DM Gang");
	ShowNameTags(1);
	ShowPlayerMarkers(1);
	SetWorldTime(17);
	SetWeather(10);
	UsePlayerPedAnims();
    for(new i = -1; i < 300; i++) if(IsSkinValid(i)) AddPlayerClass(i,-2667.4729,1594.8196,217.2739,56.19,1,1,31,200,12,1);
...
//textdraws
	...
	Help = TextDrawCreate(4.000000, 431.500000, "~y~/MENU /C /T /DM /GOD /CAR /TUNE /SNOS /JUMP /RADIO /HIDEUI");
	...
	ServerIP = TextDrawCreate(486.000000, 2.000000, "~y~Everystuff: 64.251.25.191:26000"); //was 150 422
	TextDrawSetOutline(ServerIP, 1);
	TextDrawFont(ServerIP, 1);
	TextDrawSetProportional(ServerIP, 2);
	TextDrawLetterSize(ServerIP, 0.25, 0.75);
...
public OnPlayerCommandText(playerid, cmdtext[]) {
	...
	#endif
	#if defined PROPERTIES
//	dcmd(disablecp,9,cmdtext);
	dcmd(propertyinfo,12,cmdtext);
	dcmd(disableproperty,15,cmdtext);
	dcmd(enableproperty,14,cmdtext);
	dcmd(myproperties,12,cmdtext);
	dcmd(buyproperty,11,cmdtext);
	dcmd(sellproperty,12,cmdtext);
	dcmd(locateproperty,14,cmdtext);
	dcmd(setpropertyprice,16,cmdtext);
	dcmd(setpropertyvalue,16,cmdtext);
	dcmd(setpropertyearning,18,cmdtext);
	dcmd(getpropertyid,13,cmdtext);
	dcmd(saveproperty,12,cmdtext);
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOR_LIGHTBLUE,"{33CCFF}[REPORT]:{C0C0C0} To report a player who is cheating, use the /report command. Ex:  {FFFFFF}/report 4 infinite rpg");
...
public OnPlayerSpawn(playerid)
{
	...
	{
	    SendClientMessage(playerid,0xADFF2FFF,"Using Sandra's Property System! Type /propertyhelp for property commands.");
		#if defined TEXTDRAWS
	...
	switch(gTeam[playerid])
	{
		case 0:
	    {
...
#if defined USE_SPAWN_INFO
			SetSpawnInfo(playerid,0,pskin[playerid],-2667.4729,1594.8196,217.2739,56.19,1,1,31,200,12,1);
#else
			...
			{
				case 0: dcmd_airport(playerid,params2);//ls airport
		        case 1: dcmd_boneyard(playerid,params2); //aa boneyard
		        case 2: dcmd_chiliad(playerid,params2);
		        case 3: dcmd_sf(playerid,params2); //sf airport
		        case 4: dcmd_lv(playerid,params2); //lv airport
		        case 5: dcmd_ls(playerid,params2); //ls downtown
		        case 6: dcmd_sfd(playerid,params2); //sf downtown
		        case 7: dcmd_lvstrip(playerid,params2); //lv downtown
		        case 8: dcmd_desert(playerid,params2); //desert town
		        case 9: dcmd_sex(playerid,params2); //sex shop
				case 10: dcmd_random(playerid,params2); //random
...
public OnPlayerDeath(playerid, killerid, reason)
{
	...
	if(RaceParticipant[playerid]) LeaveRace(playerid);
	KillPlayerVehicle(playerid);
	if(reason == 12) GivePlayerMoney(killerid,5000); //vibrator = more money
	else if(reason == 51 || reason == 50) //explosion or helikill
	{
	    GetPlayerPos(playerid,playerx,playery,playerz);
	    foreach(Player,i)
		{
		...
		if(reason == 50)
		{
		    ...
		    else SendClientMessage(killerid,COLOR_YELLOW,"WARNING: Continued helikills will result in being kicked from the server!");
		}
	}
	//actions based on team
	if(gTeam[killerid] >= 50 && gTeam[killerid] == gTeam[playerid]) SetPlayerHealth(killerid,0.0); // anti-team kill
	...
	else if(!gTeam[killerid] && !gTeam[playerid]) //freeroamers killing each other = wanted
	{
	    if(reason == 38 && godmode[playerid])
		{
			ResetPlayerWeapons(killerid);
			GameTextForPlayer(killerid,"~r~DONT MINIGUN PEOPLE~n~~r~IN GOD MODE!",5000,3);
			dcmd_kill(killerid,params2);
		}
	...
	if((GetTickCount()-GetPVarInt(killerid, "deathtime")) < 220)
    {
  	...
  	//if a human did the killing....
  	if(killerid != INVALID_PLAYER_ID)
  	{
  	    kills[killerid]++; // ... give the human credit
  	...
  	if(reason != 255) SendDeathMessage(killerid,playerid,reason); //if they didnt suicide
	return 1;
}
...
//            if(pvehicleid[playerid] != INVALID_VEHICLE_ID) GetVehicleZAngle(pvehicleid[playerid], playera);
	...
	if(godmode[playerid]) SetPlayerChatBubble(playerid,"GOD MODE",COLOR_CONFIRM,150.0,1000);
    #if defined ANTI_CARJACK
...
public OnPlayerTakeDamage(playerid, issuerid, Float: amount, weaponid)
{
	if(issuerid != INVALID_PLAYER_ID)
	{
	    ...
	    if(weaponid == 38)
		{
			if(pstate[issuerid] == PLAYER_STATE_ONFOOT)
		    {
		        if(gTeam[issuerid] != 10)
				{
				    format(string128,sizeof(string128),"[hack][minigun] Kicked [%i]%s for minigun cheat. Victim:%i %s",issuerid,pname[issuerid],playerid,pname[playerid]);
				    SendClientMessageToAll(COLOR_YELLOW,string128);
					printf(string128);
					Kick(issuerid);
					return 1;
		...
		else
	    {
		    ...
		    SetPlayerChatBubble(playerid,string16,COLOR_DARKRED,150.0,2500);
		}
		return 1;
	}
	else
	{
	    if(!gTeam[playerid]) //if not in dm
	    {
	        if(godmode[playerid])
	        {
//			    format(string16,sizeof(string16),"GOD  MODE");
			    SetPlayerChatBubble(playerid,"GOD MODE",COLOR_CONFIRM,150.0,3000);
				SetPlayerArmour(playerid,100);
				SetPlayerHealth(playerid,100);
	        
	        }
		    if(jump[playerid] && weaponid != 51)
			{
			    new Float:health;
				GetPlayerHealth(playerid,health);
				if(health+amount < 95.0) SetPlayerHealth(playerid,health+amount);
				else SetPlayerHealth(playerid,99.0);
			}
		}
		else //if in dm area
		{
		    if(godmode[playerid]) dcmd_god(playerid,params2);
		}
	}
...
public OnPlayerGiveDamage(playerid, damagedid, Float: amount, weaponid)
{
    if(weaponid == 4)
    {
        if(IsPlayerAdmin(playerid))
        {
        	...
        	SetPlayerArmour(playerid,100.0);
        	SendClientMessageToAll(COLOR_SYSTEM,"BAAAAAAAAAAARRRRRRRRRRRFFFFFFFFFFFF");
        	foreach(Player,i)
        	{
...
public OnPlayerClickMap(playerid, Float:fX, Float:fY, Float:fZ)
{
	...
	if(!RaceParticipant[playerid] && !gTeam[playerid])
	{
		...
		else SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot map-teleport while in a vehicle. Please exit the vehicle and try again.");
	}
	else SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot teleport at this time.  Type {CC0000}/leave{C0C0C0} and then try the map-teleport again.");
    return 1;
}
...
//	 	if(!jump[playerid] || gTeam[playerid] || RaceParticipant[playerid]) return 1;
	...
	else if(newkeys & KEY_YES)
	{
		...
		switch(keyy[playerid])
		{
			...
			case KEYY_TELE: dcmd_tele(playerid,params2);
			case KEYY_DM: dcmd_dm(playerid,params2);
			case KEYY_CAR: dcmd_car(playerid,params2);
	...
	else if ((newkeys & KEY_CROUCH) && pstate[playerid] == PLAYER_STATE_DRIVER)
	{
	    if(horn[playerid])
	    {
	...
	else if(newkeys & KEY_FIRE)
	{
		...
		if((cow[playerid] != INVALID_OBJECT_ID)) //cows go boom
		{
		    if(!godmode[playerid])
			{
				...
				CreateExplosion(playerx, playery, playerz, 12, 1);
			}
		}
	}
...
public OnVehicleMod(playerid, vehicleid, componentid)
{
    ...
    if (!modok)
	{
        ...
        printf("[ban] Banned [%i]%s for trying to crash players with illegal car mods",playerid,pname[playerid]);
    }
    return 1;
}
...
public OnPlayerEnterVehicle(playerid, vehicleid)
{
	foreach(Player,i)
	{
	    if(vehicleid == playercar[i] && i != playerid && reserve[i])
	    {
	        ...
	        return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} This vehicle is reserved by its creator. You may not enter the vehicle.");
	    }
	}
...
//			horn[playerid] = 0;
		...
		case 2: //driver
		{
			...
			if(modelid == 525) GameTextForPlayer(playerid,"Press ACTION to tow vehicles!!",3000,3);
...
//			new str[32];
			...
			GameTextForPlayer(playerid, string32, 3000, 1);
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == D_COMMANDS && response)
	{
 	    switch(listitem)
	    {
	        case 0: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/god command","{FFFFFF}Type /god to switch in and out of god-mode.","Back","Exit");
	        case 1: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/register command","{FFFFFF}Type /register to set up a password here.","Back","Exit");
	        case 2: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/login command","{FFFFFF}Type /login to sign-in to account.","Back","Exit");
	        case 3: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/ignore command","{FFFFFF}Type /ignore <id> to not see their chat/PM. Example: /ignore 4","Back","Exit");
	        case 4: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/pm command","{FFFFFF}Type /pm <id> <message>to send a private message. Example: /pm 4 hi!","Back","Exit");
	        case 5: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/spawn command","{FFFFFF}Type /spawn to open menu and choose default respawn location.","Back","Exit");
	        case 6: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/tele or /t command","{FFFFFF}Type /tele to bring up teleport menu.","Back","Exit");
	        case 7: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/dm command","{FFFFFF}Type /dm to bring up deathmatch area menu.","Back","Exit");
	        case 8: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/car or /v command","{FFFFFF}Type /car or /v to open car spawn menu. Add the modelid or name to spawn specific cars. Example: /v 522","Back","Exit");
			case 9: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/propertyhelp command","{FFFFFF}Type /propertyhelp to see a list of property-related commands","Back","Exit");
	        case 10: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/glasses command","{FFFFFF}Type /glasses <1-33> to wear glasses/sunglasses. Example: /glasses 3 ","Back","Exit");
            case 11: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/sp command","{FFFFFF}Type /sp to save your current position. Use /lp to go to last (saved) position ","Back","Exit");
            case 12: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/lp command","{FFFFFF}Type /lp to go to last (saved) position. Use /sp to save a position before using /lp ","Back","Exit");
            case 13: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/key2 command","{FFFFFF}Type /key2 to open a menu and add a function/command to the 2 key (usually fix+NOS). ","Back","Exit");
            case 14: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/keyy command","{FFFFFF}Type /keyy to open a menu and add a function/command to the Y key (usually /tele). ","Back","Exit");
            case 15: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/keyn command","{FFFFFF}Type /keyn to open a menu and add a function/command to the N key (usually /stop). ","Back","Exit");
            case 16: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/lock command","{FFFFFF}Type /lock to lock your vehicle doors","Back","Exit");
            case 17: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/unlock command","{FFFFFF}Type /unlock to unlock your vehicle doors","Back","Exit");
            case 18: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/vr or /fix command","{FFFFFF}Type /vr or /fix to repair vehicle body panels and health. This happens automatically if player is in god-mode","Back","Exit");
            case 19: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/flip command","{FFFFFF}Type /flip to flip your vehicle onto its wheels. Can be added to key2","Back","Exit");
//            case 20: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/speedo command","{FFFFFF}Type /speed to turn on digital on-screen speedometer ","Back","Exit");
            case 20: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/nos command","{FFFFFF}Type /nos to add NOS (speed-boost) to your vehicle. Does not work on some vehicles! ","Back","Exit");
            case 21: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/snos command","{FFFFFF}Type /snos to enable SUPER NOS. When SNOS is on, tap the FIRE/SECONDARY FIRE key for super-speed.\n\nPlease check your keymapping in esc->options to find FIRE/SECONDARYFIRE key.","Back","Exit");
            case 22: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/neon command","{FFFFFF}Type /neon to bring up menu and add neon lights to vehicle. Does not work on some vehicles! ","Back","Exit");
            case 23: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/tune command","{FFFFFF}Type /tune to bring up menu and add spoilers, body panels, rims, hydraulics, etc ","Back","Exit");
            case 24: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/color command","{FFFFFF}Type /color to bring up menu and change vehicle color. ","Back","Exit");
            case 25: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/paintj command","{FFFFFF}Type /paintj to bring up menu and change vehicle paint-job. Does not work on some vehicles! ","Back","Exit");
            case 26: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/wheels command","{FFFFFF}Type /wheels to bring up menu and change vehicle wheels/rims. ","Back","Exit");
            case 27: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/horn command","{FFFFFF}Type /horn to add train-horn to vehicle. ","Back","Exit");
            case 28: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/putmine command","{FFFFFF}Type /putmine to place a bounce-mine object. Crash into mine object at high rate of speed in a heavy vehicle ","Back","Exit");
            case 29: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/putramp command","{FFFFFF}Type /putramp to place a stunt ramp ","Back","Exit");
            case 30: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/putskulls command","{FFFFFF}Type /putskulls to create a car-cannon (dual-skull icon). Drive into icon to launch vehicle ","Back","Exit");
            case 31: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/findcar command","{FFFFFF}Type /findcar to teleport to your vehicle","Back","Exit");
            case 32: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/getcar command","{FFFFFF}Type /getcar to bring your vehicle to your position ","Back","Exit");
            case 33: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/gunship command","{FFFFFF}Type /gunship to add rocket-launcher to vehicle. Click FIRE to shoot ","Back","Exit");
            case 34: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/jump command","{FFFFFF}Type /jump to enable super-jump/bunny-hop. Tap JUMP to hop. ","Back","Exit");
            case 35: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/join command","{FFFFFF}Type /join to participate in a race","Back","Exit");
            case 36: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/kill command","{FFFFFF}Type /kill for the easy way out","Back","Exit");
            case 37: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/skin command","{FFFFFF}Type /skin <0 - 299> to change skin. Example: /skin 87 ","Back","Exit");
            case 38: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/pcolor command","{FFFFFF}Type /pcolor to open menu and change your player color","Back","Exit");
            case 39: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/wrc command","{FFFFFF}Type /wrc to spawn the greatest rally car in the world ","Back","Exit");
            case 40: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/count command","{FFFFFF}Type /count to start a 3-2-1-GO countdown","Back","Exit");
            case 41: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/jetpack command","{FFFFFF}Type /jetpack to give yourself a jetpack ","Back","Exit");
            case 42: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/pc command","{FFFFFF}Type /pc to give yourself a parachute ","Back","Exit");
            case 43: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/gun command","{FFFFFF}Type /gun to open menu and select a new weapon (or 10)","Back","Exit");
            case 44: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/fight command","{FFFFFF}Type /fight to open menu and choose new hand-to-hand fighting style ","Back","Exit");
            case 45: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/drunk command","{FFFFFF}Type /drunk to GREATLY increase you drunken-ness level  ","Back","Exit");
            case 46: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/time command","{FFFFFF}Type /time <0-23> to change the time (day/night). Example: /time 12 ","Back","Exit");
            case 47: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/pweather command","{FFFFFF}Type /pweather to change the weather. Use an ID to change to specific weatherid. Example: /pweather 8 ","Back","Exit");
            case 48: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/s command","{FFFFFF}Type {C0C0C0}/s{FFFFFF} to open the player-sounds menu. More sounds being added all the time!","Back","Exit");
            case 49: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/anims command","{FFFFFF}Type /anims for a list (in chat console) of avilable animations ","Back","Exit");
            case 50: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/chicken command","{FFFFFF}Type /chicken to become a giant chicken ","Back","Exit");
            case 51: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/cow command","{FFFFFF}Type /cow to become a giant cow ","Back","Exit");
            case 52: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/porn command","{FFFFFF}Type /porn to have some alone time ","Back","Exit");
            case 53: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/hsmoke command","{FFFFFF}Type /hsmoke to have a quick break from...whatever ","Back","Exit");
			case 54: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/tow command","{FFFFFF}Type /tow to tow any vehicle, WITH any vehicle!!","Back","Exit");
			case 55: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/junk command","{FFFFFF}Type /junk to damage your vehicle and flatten all tires ","Back","Exit");
            case 56: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/rules command","{FFFFFF}Type /rules to see server rules (no cheating, etc)","Back","Exit");
            case 57: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/radio command","{FFFFFF}Type /radio to listen to Music, REAL Police, Fire, EMS and Amateur Radio scanner audio feeds","Back","Exit");
			case 58: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/trailer command","{FFFFFF}Type /trailer to spawn a vehicle trailer. Note: You CAN have both a player-spawned vehicle AND player-spawned trailer!","Back","Exit");
            case 59: ShowPlayerDialog(playerid, D_HELP, DIALOG_STYLE_MSGBOX, "/e(ject) command","{FFFFFF}Type /e to eject (emergency-exit) yourself from a vehicle!","Back","Exit");
		}
...
// 9020,9402,9437,9613,9624,9639,10402,10408,10600,10607,10801,dcmd_s
	...
	else if(dialogid == D_MENU && response)
	{
	    switch(listitem)
	    {
	        ...
	        case 2: dcmd_car(playerid,params2);
	        case 3: dcmd_radio(playerid,params2);
	        case 4: dcmd_gun(playerid,params2);
	        case 5: dcmd_spawn(playerid,params2);
	        case 6: dcmd_key2(playerid,params2);
	        case 7: dcmd_keyy(playerid,params2);
	        case 8: dcmd_keyn(playerid,params2);
	        case 9: dcmd_weather(playerid,params2);
	        case 10: dcmd_pcolor(playerid,params2);
	        case 11: dcmd_cmd(playerid,params2);
	        case 12: dcmd_help(playerid,params2);
	...
	else if(dialogid == D_RADIO && response)
	{
	    switch(listitem)
	    {
		    ...
		    case 1: ShowPlayerDialog(playerid, D_RADIOPOLICE, DIALOG_STYLE_LIST, "Choose Police Radio","Los Angeles PD\nLas Vegas PD\nSan Francisco PD\nMaine PD\nNew York PD\nNew York Fire/EMS\nChicago PD\nAtlanta PD\nHouston PD\nMiami PD\nToronto PD\nAUS Victoria PD","Listen","Exit");
            case 2: ShowPlayerDialog(playerid, D_RADIOHAM, DIALOG_STYLE_LIST, "Choose Amateur Radio","GB7OK/UK\nUS Hurricane Net\nKB2FAF/NY\nDSTAR Reflector\nK4PIP Reflector\nLinked Repeater System","Listen","Exit");
            case 3: ShowPlayerDialog(playerid, D_RADIOAIR, DIALOG_STYLE_LIST, "Choose Airport Radio","Czech Brno-Turany\nNew York JFK\nSan Francisco SFO ","Listen","Exit");
            case 4: ShowPlayerDialog(playerid, D_RADIOMUSIC, DIALOG_STYLE_LIST, "Choose Music Radio",".977 Hitz\n90s Alternative\nTop 40\nDub Step\nHip Hop\nUnderground Rap\nRock and Roll\nOpera\nClassical\nBlues\nTechno\nTrip Hop\nBollywood\nVideo Game\nMovie\nMetal\nNews\n50s and 60s Oldies\nThe 70s\nThe 80s","Listen","Exit");
	    }
		return 1;
	}
	...
	else if(dialogid == D_VBOAT && response)
	{
	    switch(listitem)
	    {
	        case 0: CreatePlayerTrailer(playerid,472); //coastguard
	        case 1: CreatePlayerTrailer(playerid,473); //dinghy
	        case 2: CreatePlayerTrailer(playerid,493); //jetmax
	        case 3: CreatePlayerTrailer(playerid,595); //launch
	        case 4: CreatePlayerTrailer(playerid,484); //marquis
	        case 5: CreatePlayerTrailer(playerid,430); //predator
	        case 6: CreatePlayerTrailer(playerid,453); //reefer
	        case 7: CreatePlayerTrailer(playerid,452); //speeder
	        case 8: CreatePlayerTrailer(playerid,446); //squalo
	        case 9: CreatePlayerTrailer(playerid,454); //tropic
	...
	else if(dialogid == D_COLOR && response)
	{
	    ...
	    switch(listitem)
	    {
	        ...
	        case 2: { color = 29; chosen = 1;}
	        case 3: { color = 103; chosen = 1;}
	        case 4: { color = 3; chosen = 1;}
	        case 5: { color = 6; chosen = 1;}
	        case 6: { color = 86; chosen = 1;}
	        case 7: { color = 175; chosen = 1;}
	        case 8: { color = 131; chosen = 1;}
	        case 9: { color = 151; chosen = 1;}
	        case 10: { color = 158; chosen = 1;}
	        case 11: { color = 186; chosen = 1;}
	        case 12: { color = 183; chosen = 1;}
	    }
	    if(chosen)
	    {
	...
	else if(dialogid == D_PCOLOR && response)
	{
	    switch(listitem)
	    {
	        case 0: SetPlayerColor(playerid,COLOR_PINK);
	        case 1: SetPlayerColor(playerid,COLOR_DARKRED);
	        case 2: SetPlayerColor(playerid,COLOR_BLUE);
	        case 3: SetPlayerColor(playerid,COLOR_LIGHTBLUE);
	        case 4: SetPlayerColor(playerid,COLOR_GREEN);
	        case 5: SetPlayerColor(playerid,COLOR_LIGHTGREEN);
	        case 6: SetPlayerColor(playerid,COLOR_YELLOW);
	        case 7: SetPlayerColor(playerid,COLOR_GREENYELLOW);
	        case 8: SetPlayerColor(playerid,COLOR_PURPLE);
	        case 9: SetPlayerColor(playerid,COLOR_VIOLET);
	        case 10: SetPlayerColor(playerid,COLOR_ORANGE);
	        case 11: SetPlayerColor(playerid,COLOR_BROWN);
	    }
		return 1;
	}
	else if(dialogid == D_SETSPAWN && response)
	{
	    switch(listitem)
	    {
	     	case 0: setspawn[playerid] = 0; //ls airport
	        case 1: setspawn[playerid] = 1; //aa boneyard
	        case 2: setspawn[playerid] = 2; // chiliad
	        case 3: setspawn[playerid] = 3; //sf airport
	        case 4: setspawn[playerid] = 4; //lv airport
	        case 5: setspawn[playerid] = 5; //ls downtown
	        case 6: setspawn[playerid] = 6; //sf downtown
	        case 7: setspawn[playerid] = 7; //lv downtown
	        case 8: setspawn[playerid] = 8; //desert town
	        case 9: setspawn[playerid] = 9; //sex shop
		}
		return 1;
	}
...
//	        #define SPAO{%0,%1,%2,%3,%4,%5} SetPlayerAttachedObject(playerid, HELMET_SLOT, 18645, 2, (%0), (%1), (%2), (%3), (%4), (%5));
	...
	{
		if(RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	    switch(listitem)
	    {
	...
	{
		if(RaceParticipant[playerid] > 0) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	    switch(listitem)
	    {
...
{
	ShowPlayerDialog(playerid, D_COMMANDS, DIALOG_STYLE_LIST, "Commands-See below for ALL","god\nregister\nlogin\nignore\npm\nspawn\ntele\ndm\ncar\npropertyhelp\nglasses\nsp\nlp\nkey2\nkeyy\nkeyn\nlock\nunlock\nvr\nflip\nnos\nsnos\nneon\ntune\ncolor\npaintj\nwheels\nhorn\nputmine\nputramp\nputskulls\nfindcar\ngetcar\ngunship\njump\njoin\nkill\nskin\npcolor\nwrc\ncount\njetpack\npc\ngun\nfight\ndrunk\ntime\nweather\ns\nanims\nchicken\ncow\nporn\nhsmoke\ntow\njunk\nrules\nradio\ntrailer","Read","Exit");
    SendClientMessage(playerid,COLOR_BRIGHTGREEN,"god,register,login,ignore,pm,spawn,tele,dm,car,trailer,propertyhelp,glasses,sp,lp,key2,keyy,keyn,lock,unlock,reserve");
	SendClientMessage(playerid,COLOR_BRIGHTGREEN,"toys,day,night,radio,tow,flip,nos,snos,neon,tune,color,paintj,wheels,horn,putmine,putramp,putskulls,findcar,getcar,flymode");
	SendClientMessage(playerid,COLOR_BRIGHTGREEN,"beer,wine,blunt,vr,e(ject),gunship,jump,join,kill,skin,pcolor,wrc,count,jetpack,pc,gun,fight,drunk,time,weather,piss,anims,afk");
	SendClientMessage(playerid,COLOR_BRIGHTGREEN,"stats,leave,menu,airports,stadiums,t,v,c,cities,drunk,launch,trucks,leftovers,trucker,casino,skyway,chiliad,ls,lv,sf ");
	SendClientMessage(playerid,COLOR_BRIGHTGREEN,"prohouse,fireme,dcar,stop,helmet,shamal,plane,boat,nrg,bikes,fastcars,gang,chicken,cow,porn,hsmoke,daynight,junk,rules,xmas");
	return 1;
...
{
	if(!pro[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"This command is for PRO (donator) players.");
    new string[128];
...
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot use /afk at this time. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(afk[playerid])
	{
	    SetPlayerPosEx(playerid,storedx[playerid],storedy[playerid],storedz[playerid],storeda[playerid],storedint[playerid]);
	    TogglePlayerControllable(playerid,true);
...
dcmd_drunk(const playerid, const params[])
{
	...
	else
	{
		...
		if((idx+drunk) > 49999) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} Sorry, that would put you over the maximum drunk level of 50000. Try again.");
...
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	new Float:x, Float:y, Float:z;
	if(pstate[playerid] == PLAYER_STATE_DRIVER)
	{
...
{
   	if((gTeam[playerid] || RaceParticipant[playerid]) && !jump[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(!jump[playerid])
	{
	    jump[playerid] = 1;
...
{
	if(afk[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in AFK mode. Type {CC0000}/afk{C0C0C0} to leave.");
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	GetPlayerPos(playerid, playerx, playery, playerz);
...
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	else if(afk[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in AFK mode. Type {CC0000}/afk{C0C0C0} to leave.");
	if(IsPlayerAdmin(playerid))
	{
...
dcmd_gunship(playerid,params[])
{
	...
	else return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} Unable to use command. Make sure you are driving a vehicle before using /gunship");
    ...
    switch(godmode[playerid])
	{
	    case 0:
	    {
			if(!gTeam[playerid])
			{
				...
				else return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot use /god at this time. 2 min cooldown in effect");
...
dcmd_skin(const playerid, const params[])
 {
	...
	if(!IsSkinValid(skin)) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} Invalid skinid. Get the list here http://wiki.sa-mp.com/wiki/Skins:All");
	else {
		...
		else SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be  on-foot to change skin");
	}
	return 1;
	#pragma unused params
}
...
dcmd_setspawn(const playerid, const params[])
 {
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
    ShowPlayerDialog(playerid, D_SETSPAWN, DIALOG_STYLE_LIST, "Choose Default Respawn Location","LS Airport\nAbandoned Airport\nMt Chililad\nSF Airport\nLV Airport\nLS Downtown\nSF Downtown\nLV Downtown\nDesert Town\nSex Shop\nRandom","Select","Close");
	return 1;
	#pragma unused params
}
...
{
	if(pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be driving a vehicle to use this command!");
...
{
	if(!IsPlayerAdmin(playerid)) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} rban is for rcon admins only!");
	if(!strlen(params)) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} I need a playerid to ban");
	else
	{
	    new idx;
...
{
	if(afk[playerid]) dcmd_afk(playerid,params2);
	if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(!strlen(params))
	{
...
{
	if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	else
	{
...
dcmd_pweather(const playerid, const params[])
{
	if(afk[playerid]) dcmd_afk(playerid,params2);
	if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(!strlen(params)) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} Please include a weather ID from 1 - 45 ex. '/pweather 8' You can use any number below 9999 at your own risk");
	else
	{
		...
		else SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} That weather id invalid, or has not been tested for compatibility.");
	}
	#pragma unused params
	return 1;
}
...
{
    if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(afk[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in AFK mode. Type /afk to leave.");
...
dcmd_jihad(const playerid, const params[])
{
	...
	else return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You may only blow-up cars you've created.");
...
{
	if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
    if(!playercar[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You do not have a car to teleport to. Use /car or /v to create a vehicle");
	else
	{
		new Float:x, Float:y, Float:z;
...
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	if(pstate[playerid] == PLAYER_STATE_DRIVER)
	{
...
{
	if(pvehicleid[playerid] == INVALID_VEHICLE_ID || pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be in a vehicle to use this command");
	else ShowPlayerDialog(playerid, D_COLOR, DIALOG_STYLE_LIST, "Select Vehicle Color","Black\nWhite\nGrey\nBlue\nRed\nYellow\nGreen\nPurple\nBright Green\nBright Red\nKing Blue\nNeon Purple\nBarbie Pink", "Select", "Close");
	return 1;
	#pragma unused params
}
...
{
	ShowPlayerDialog(playerid, D_RULES, DIALOG_STYLE_MSGBOX, "Everystuff Rules","-No hacks of any type\n-No spamming\n-No server advertising\n-No abusing bugs or exploits...report them!\n-Harassing via chat or PM will get you muted/wired","Play!", "");
	return 1;
	#pragma unused params
}
...
dcmd_savepos(const playerid, const params[])
{
	if(afk[playerid])
	{
		...
		return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in AFK mode. Type /afk to leave.");
	}
	else if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a DM or AFK, or you are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
...
dcmd_dm(const playerid, const params[])
{
	...
	if(!strlen(params)) ShowPlayerDialog(playerid, D_DM, DIALOG_STYLE_LIST, "DM Areas (type /leave to exit DM)","Gang War DM\nDesert Eagle DM\nContainer Ship\nMilitary War\nFlamethrower\nSawnOff DM\nSniper DM\nRPG Arena\nMinigun DM\nKatana Fight\nHome Invasion", "Select", "Close");
	return 1;
	#pragma unused params
}
...
dcmd_derby(const playerid, const params[])
{
	...
	SendClientMessage(playerid, COLOR_CONFIRM, "{33AA33}[CONFIRM]:{C0C0C0} SF Demolition Derby.");
...
{
	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	else SetPlayerPosEx(playerid, 315.745086,984.969299,1958.919067,263.0,9);
	return 1;
	#pragma unused params
...
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	...
	else return SendClientMessage(playerid,COLOR_ERROR,"You are not insultman911 :( " );
	return 1;
	#pragma unused params
...
//	if(gTeam[playerid] || RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}ERROR: {C0C0C0}You must type {CC0000}/leave{C0C0C0} to exit the race/DM before you can use this command.");
	...
	else return SendClientMessage(playerid,COLOR_ERROR,"You may acquire PRO status by donating! http://everystuff.net/donate" );
	return 1;
	#pragma unused params
...
dcmd_register(playerid,params[]) {
		if(blockregister[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} This is a temporary name and you CAN NOT register it. Please re-log w/ a different name!");
...
//			SendClientMessageToAll(COLOR_GREY,string256);
	 	...
	 	{
		 	OnPlayerLogin(playerid,false); SendClientMessage(playerid,red,"Syntax Error: \"/LOGIN <PASSWORD>\".");
	 	}
		format(string256,sizeof(string256),"{FFFFFF}[LOGIN]: {%06x}%s {FFFFFF}has logged in successfully! {C0C0C0}Kills:{FF66FF}%i {C0C0C0}Wins:{FF66FF}%i {C0C0C0}Money:{FF66FF}$%i",GetPlayerColor(playerid) >>> 8,pname[playerid],Variables[playerid][Kills],Variables[playerid][RaceWins],Variables[playerid][Money]);
		SendClientMessageToAll(COLOR_GREY,string256);
...
dcmd_gethere(playerid,params[]) {
	if(IsPlayerCommandLevel(playerid,"gethere")) {
		...
		if(IsPlayerConnected(id) && id != INVALID_PLAYER_ID && id != playerid) {
			...
			format(string128,sizeof(string128),"You have been teleported to \"%s's\" location.",PlayerName); return SendClientMessage(id,yellow,string128);
...
dcmd_say(playerid,params[]) {
    if(IsPlayerCommandLevel(playerid,"say")) {
		...
		new name[24]; GetPlayerName(playerid,name,24); format(string128,sizeof(string128),"** Admin %s: %s",name,params);
		printf(string128);
    ...
    if(IsPlayerCommandLevel(playerid,"wire")) {
		...
		if(IsPlayerConnected(id) && id != INVALID_PLAYER_ID && id != playerid) {
		    if(!Variables[id][Wired]) {
			    ...
			    if(!strlen(params[strlen(tmp)+1])) format(string128,sizeof(string128),"\"%s\" has been wired by Administrator \"%s\".",ActionName,name);
				else format(string128,sizeof(string128),"\"%s\" has been wired by Administrator \"%s\". (Reason: %s)",ActionName,name,params[strlen(tmp)+1]);
    ...
    if(IsPlayerCommandLevel(playerid,"unwire")) {
		...
		if(IsPlayerConnected(id) && id != INVALID_PLAYER_ID) {
		    if(Variables[id][Wired]) {
			    ...
			    if(id != playerid) { format(string128,sizeof(string128),"\"%s\" has been unwired by Administrator \"%s\".",ActionName,name); printf(string128); return SendClientMessageToAll(yellow,string128); }
...
dcmd_xjail(playerid,params[]) {
	if(IsPlayerCommandLevel(playerid,"xjail")) {
		...
		if(IsPlayerConnected(id) && id != INVALID_PLAYER_ID && id != playerid) {
			...
			new name[24],ActionName[24]; GetPlayerName(playerid,name,24); GetPlayerName(id,ActionName,24);
			format(string128,sizeof(string128),"Administrator \"%s\" has jailed you.",name); SendClientMessage(id,yellow,string128); format(string128,sizeof(string128),"You have jailed \"%s\".",ActionName); SendClientMessage(playerid,yellow,string128);
...
dcmd_xunjail(playerid,params[]) {
	if(IsPlayerCommandLevel(playerid,"xunjail")) {
		...
		if(IsPlayerConnected(id) && id != INVALID_PLAYER_ID && id != playerid) {
			...
			new name[24],ActionName[24]; GetPlayerName(playerid,name,24); GetPlayerName(id,ActionName,24);
			if(id != playerid) { format(string128,sizeof(string128),"Administrator \"%s\" has unjailed you.",name); SendClientMessage(id,yellow,string128); format(string128,sizeof(string128),"You have unjailed \"%s\".",ActionName); SendClientMessage(playerid,yellow,string128); }
...
dcmd_xcommands(playerid,params[]) {
	...
	SendClientMessage(playerid,yellow,"adminhq,announce,(un)freeze,gethere,goto,xspec,ip,kick,ban,setwanted,wire,xjail,xunjail"); //   settime,goto,gethere,say,asay,aslap,(un)wire,awire,kick,akick,ban,aban,xspec,giveweapon,giveallweapon,xcommands,weather,eject,explode,setwanted,setallwanted");
...
#if defined PROPERTIES
dcmd_propertyinfo(playerid,params[])
{
	new idx;
	new tmp[256];
	tmp = strtok(params, idx);
...
dcmd_disableproperty(playerid,params[])
{
...
dcmd_enableproperty(playerid,params[])
{
    if(!IsPlayerAdmin(playerid)) return 0;
    new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
dcmd_buyproperty(playerid,params[])
{
    BuyPropertyForPlayer(playerid);
	return 1;
	#pragma unused params
}
dcmd_sellproperty(playerid,params[])
{
	SellPropertyForPlayer(playerid);
	return 1;
	#pragma unused params
}
dcmd_locateproperty(playerid,params[])
{
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
	if(!strlen(tmp))
...
dcmd_setpropertyprice(playerid,params[])
{
	if(!IsPlayerAdmin(playerid)) return 0;
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
dcmd_setpropertyvalue(playerid,params[])
{
    if(!IsPlayerAdmin(playerid)) return 0;
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
dcmd_setpropertyearning(playerid,params[])
{
    if(!IsPlayerAdmin(playerid)) return 0;
	new tmp[128]; new idx;
	tmp = strtok(params, idx);
...
dcmd_getpropertyid(playerid,params[])
{
...
dcmd_saveproperty(playerid,params[])
{
	if(!IsPlayerAdmin(playerid)) return 0;
...
dcmd_propertyhelp(playerid,params[])
{
	...
	SendClientMessage(playerid, 0x0FFFFFFAA, "/locateproperty [ID], /propertyinfo [ID]");
	if(IsPlayerAdmin(playerid))
	{
...
dcmd_join(const playerid, const params[]) {
	...
	else if(pstate[playerid] != PLAYER_STATE_DRIVER) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You must be driving a vehicle in order to join a race");
	else if(cantrace[playerid] == true || aircraft[playerid] == true) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot join the race with your current vehicle. Please choose a different type.");
	else if(gTeam[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot join a race until you have left the DM area. Type /leave first.");
...
public CreatePlayerVehicle(playerid, modelid) {
	...
	switch(modelid)
	{
  	...
  	else if(bad) return SendClientMessage(playerid, COLOR_ERROR, "{CC0000}[ERROR]:{C0C0C0} Sorry homie, you can't spawn that vehicle at this time!");
	if(RaceParticipant[playerid] && (bad || trailer || plane)) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You cannot spawn this vehicle during a race. Type /leave to leave the race.");
	if(playercar[playerid] != INVALID_VEHICLE_ID)
	{
...
// DEATHMATCH ROUTINES  **********  USING SETSPAWNINFO   **************
#if defined DM
#if defined USE_SPAWN_INFO
forward MilitaryDM(playerid);
public MilitaryDM(playerid)
{
	if(RaceParticipant[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} You are in a race. Type {FFFF00}/leave{C0C0C0} and then try your command again.");
	if(godmode[playerid]) godmode[playerid] = 0;
    gTeam[playerid] = 5;
    SetPlayerArmour(playerid,100.0);
    SetPlayerInterior(playerid, 0);
    new rand = random(sizeof(gRandomMilitaryDM));
   	SetPlayerWorldBounds(playerid, 537.1823, -128.4566, 2370.609, 1576.513);
	SetSpawnInfo(playerid,0,287, gRandomMilitaryDM[rand][0], gRandomMilitaryDM[rand][1], gRandomMilitaryDM[rand][2]+2,56.19,16,100,31,998,35,500);
...
public SawnOffDM(playerid)
{
	...
	SetPlayerInterior(playerid, 0);
    new rand = random(sizeof(gRandomSawnOffDM));
	SetSpawnInfo(playerid,0,pskin[playerid], gRandomSawnOffDM[rand][0], gRandomSawnOffDM[rand][1], gRandomSawnOffDM[rand][2],gRandomSawnOffDM[rand][3],26,999,0,0,0,0);
   	SetPlayerWorldBounds(playerid, -2394.683, -2502.838, 716.3557, 598.0067);
  	SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public SniperDM(playerid)
{
	...
	SetPlayerInterior(playerid, 0);
	new rand = random(sizeof(gRandomSniperDM));
	SetSpawnInfo(playerid,0,pskin[playerid], gRandomSniperDM[rand][0], gRandomSniperDM[rand][1], gRandomSniperDM[rand][2],gRandomSniperDM[rand][3],34,999,0,0,0,0);
	SetPlayerWorldBounds(playerid, 362.0141, 46.7115, 1529.802, 1272.888);
    SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public RocketDM(playerid)
{
	...
	new rand = random(sizeof(gRandomRocketDM));
	SetSpawnInfo(playerid,0, pskin[playerid], gRandomRocketDM[rand][0], gRandomRocketDM[rand][1], gRandomRocketDM[rand][2],gRandomRocketDM[rand][3],35,999,0,0,0,0);
	SetPlayerWorldBounds(playerid, 887.5186, 116.7788, 385.3699, -326.9805);
    SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public MinigunDM(playerid)
{
	...
	SetPlayerInterior(playerid, 0);
	new rand = random(sizeof(gRandomMinigunDM));
    SetSpawnInfo(playerid,0,pskin[playerid], gRandomMinigunDM[rand][0], gRandomMinigunDM[rand][1], gRandomMinigunDM[rand][2]+2,gRandomMinigunDM[rand][3],38,999,0,0,0,0);
 	SetPlayerWorldBounds(playerid, 1422.014, 1269.725, 2233.659, 2098.277);
 	SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public HouseDM(playerid)
{
	...
	new rand = random(sizeof(gRandomHouseDMSpawns));
	SetSpawnInfo(playerid,0, pskin[playerid],gRandomHouseDMSpawns[rand][0], gRandomHouseDMSpawns[rand][1], gRandomHouseDMSpawns[rand][2],0.0,25,999,29,999,32,999);
	SetPlayerWorldBounds(playerid, 2493.814, 2204.798, -1062.067, -1417.363);
	SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public GasDM(playerid)
{
	...
	SetPlayerArmour(playerid,100.0);
	SetPlayerInterior(playerid, 0);
	SetSpawnInfo(playerid,0,pskin[playerid], -1324.4618,2676.7446,49.6320,86.5,37,999,0,0,0,0);
	SetPlayerWorldBounds(playerid, -1144.432, -1401.345, 2802.69, 2545.777);
	SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public ShipDM(playerid)
{
	...
	SetPlayerInterior(playerid, 0);
	new rand = random(sizeof(gRandomShipSpawns));
	SetSpawnInfo(playerid,0, pskin[playerid],gRandomShipSpawns[rand][0], gRandomShipSpawns[rand][1], gRandomShipSpawns[rand][2],0.0,25,999,29,999,32,999);
	SetPlayerWorldBounds(playerid, -2195.441, -2580.811, 1658.258, 1448.057);
	SetPlayerVirtualWorld(playerid,WORLD_DM);
	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
...
public SwordDM(playerid)
{
	...
	SetPlayerInterior(playerid, 5);
	new rand = random(sizeof(gRandomSwordDM));
	SetSpawnInfo(playerid,0, pskin[playerid],gRandomSwordDM[rand][0], gRandomSwordDM[rand][1], gRandomSwordDM[rand][2], gRandomSwordDM[rand][3],8,1,0,0,0,0);
	SetPlayerVirtualWorld(playerid,WORLD_DM);
 	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
	DMSpam(playerid);
...
public DeagleDM(playerid)
{
	...
	SetPlayerInterior(playerid, 3);
	new rand = random(sizeof(gRandomDeagleDM));
	SetSpawnInfo(playerid,0, pskin[playerid],gRandomDeagleDM[rand][0], gRandomDeagleDM[rand][1], gRandomDeagleDM[rand][2], gRandomDeagleDM[rand][3],24,999,0,0,0,0);
 	SetPlayerVirtualWorld(playerid,WORLD_DM);
 	#if defined TEXTDRAWS
	TextDrawShowForPlayer(playerid,Leave);
	DMSpam(playerid);
...
{
	if(badcar[playerid]) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} This vehcile unable to teleport!");
	if(pstate[playerid] == PLAYER_STATE_DRIVER && pvehicleid[playerid]  != INVALID_VEHICLE_ID)
	{
	    EnableStuntBonusForPlayer(playerid, false);
	    if((pmodelid[playerid] != 406 && (cantrace[playerid]) || aircraft[playerid])) return SendClientMessage(playerid,COLOR_ERROR,"{CC0000}[ERROR]:{C0C0C0} This vehicle type is not allowed to teleport.");
		new trailer2;
...
CreateObjectEx(playerid,modelid)
{
	...
	*/
	switch(modelid)
	{
	    case CHICKEN:
		{
  	//		if(x > 20) return SendClientMessage(playerid,COLOR_ERROR, "{CC0000}[ERROR]:{C0C0C0} There are a lot of other chickens and cows right now. Please try again when its less crowded");
...
public FiveMinutes()
{
	...
	if(hstnme == 5) hstnme = 0;
	switch(hstnme)
	{
		case 0:
		{
			SendRconCommand("hostname [Miami][03e]Everystuff! FR DM Stunt Super-NOS");
			hstnme++;
		}
		case 1:
		{
			SendRconCommand("hostname [Miami][03e]Everystuff! FR DM Tune Radio Bonuses");
			hstnme++;
		}
		case 2:
		{
			SendRconCommand("hostname [Miami][03e]Everystuff! FR DM ALL-VEHICLES Stunts");
			hstnme++;
		}
		case 3:
		{
			SendRconCommand("hostname [Miami][03e]Everystuff! FR DM Stunt Radio-Streams");
			hstnme++;
		}
		case 4:
		{
			SendRconCommand("hostname [Miami][03e]Everystuff! FR DM Sandbox 8===D WHEEE");
			hstnme++;
		}
	}
...
public TenMinutes()
{
	...
	foreach(Player, i)
	{
	    if(!IsPlayerNPC(i))
        {
			...
			if(!gTeam[i])
			{
				GetPlayerWeaponData(i,7,rpg,rpgammo);
				weap = GetPlayerWeapon(i);
				ammo = GetPlayerAmmo(i);
				if(rpgammo < 5) GivePlayerWeapon(i,35,1); //give 1 rpg
 	...
 	for(new i = 0; i < MAX_VEHICLES; i++)
	{
 	...
 	//	if(ppl > 50) printf("*****  ||||||||      NOTE: Population above 50 percent !!");
	...
	switch(automsg)
	{
	    ...
	    case 1: SendClientMessageToAll(COLOR_PINK,"{FF66FF}[TIP]:{C0C0C0} Register at http://madoshi.net/samp and give a shout on the forums! PM \"kaiser souse\" there if you don't get email confirmation");
	...
	#if defined IRC_ECHO
	format(string128, sizeof(string128), "05*** Current Server IP: 64.251.25.191:26000");
	IRC_GroupSay(groupID, IRC_CHANNEL, string128);
	#endif
...
public OneSecond()
{
	...
	foreach(Player,i)
	{
        if(!IsPlayerNPC(i))
        {
			...
			pworld[i] = GetPlayerVirtualWorld(i);
            surf = GetPlayerSurfingVehicleID(i);
			if(surf == INVALID_VEHICLE_ID) TextDrawHideForPlayer(i,Surfing);
			else
			{
				TextDrawShowForPlayer(i,Surfing);
				GivePlayerMoney(i,1);
			}
			GetPlayerPos(i,playerx,playery,playerz);
		    if(pstate[i] == PLAYER_STATE_DRIVER || pstate[i] == PLAYER_STATE_PASSENGER || pstate[i] == PLAYER_STATE_ONFOOT || pstate[i] == PLAYER_STATE_SPAWNED)
		    {
				...
				if(pstate[i] == PLAYER_STATE_DRIVER || pstate[i] == PLAYER_STATE_PASSENGER)
				{
			        ...
			        if(RaceParticipant[i] >= 4 && mph > 300)
			        {
...
//				        SetVehicleHealth(pvehicleid[i],0.0);
		    ...
		    if(pstate[i] == PLAYER_STATE_ONFOOT) // passengers return last weap used, not current weap, so exclude them
		    {
				    ...
				    case 35,36:
				    {
				        if(!gTeam[i])
				        {
							if(!IsPlayerAdmin(i))
							{
					           	...
					           	if(ammo > 30)
								{
						   			format(string128,sizeof(string128),"[hack][ammo] Kicked [%i]%s for RPG ammo cheat. Ammo qty: %i",i,pname[i],ammo);
									SendClientMessageToAll(COLOR_YELLOW,string128);
									printf(string128);
									ammo = 0;
									return Kick(i);
			...
			pvehicleid[i] = GetPlayerVehicleID(i);
		    pmodelid[i] = GetVehicleModel(pvehicleid[i]);
		    if(godmode[i])
			{
...
public FiveSeconds()
{
	foreach(Player,i)
	{
	    if(!IsPlayerNPC(i))
        {
//            if(safe[i] && badcar[i]) PlayerPlaySound(i,7221,0.0,0.0,0.0);
		    new area; // gang zone
		    new Float:armour, Float:health;
			GetPlayerArmour(i,armour);
		    GetPlayerHealth(i,health);
	       	if(health > 100.0) SetPlayerHealth(i,0.0);
			if(armour > 100.0) SetPlayerArmour(i,0.0);
		    if(GetVehicleModel(pvehicleid[i]) == 416 && health < 95) SetPlayerHealth(i,health+5);
...
IRCCMD:icmd(botid, channel[], user[], host[], params[])
{
	...
	if (IRC_IsVoice(botid, channel, user))
	{
		format(string128, sizeof(string128), "05*** [IRC CMDS] !isay,!ikick,!iban,!idebug, !iwhoson, !istats");
		IRC_GroupSay(groupID, channel, string128);
