...
// Connect the first bot
	...
	SetGameModeText("03e Stunt Race DM FR Everystuff");
	ShowNameTags(1);
	ShowPlayerMarkers(1);
	SetWorldTime(17);
	SetWeather(10);
	...
	if(issuerid != INVALID_PLAYER_ID)
	{
        ...
        if(!gTeam[playerid]) //freeroam
        {
            ...
            else // player is vulnerable
            {
                switch(weaponid)
                {
                    case 35,36,37,38,39: OPTDamt = amount/4; //reduce to 1/4
...
public TenMinutes()
{
	...
	IRC_GroupSay(groupID, IRC_CHANNEL, string128);
	#endif
	SendClientMessageToAll(COLOR_YELLOW,"Our 0.3x Server is 69.60.109.157:7777 -or- everystuff.net:7777 | 03x client at http://everystuff.net/client");
	return 1;
}
